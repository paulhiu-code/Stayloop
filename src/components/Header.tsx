...
export default function Header({
  ...
  const navItems = [
    ...
    { label: 'Partner program', page: 'partners' as const },
  ];

  return (
    <header className="bg-white/85 backdrop-blur-xl border-b border-gray-200 sticky top-0 z-50 shadow-lg shadow-gray-900/5">
